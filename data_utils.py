...
#    pd_id = str(config['pd_id'])
    ...
    return  data_in_path, model_path, start_date, end_date, date_range, top_n, data_out_path
...
def data_label(crime_data_continuity_norange):
    ...
    label_data = crime_data_continuity_norange.ix[crime_data_continuity_norange.value > 0, :2]
...
def sort_loss(y_, y):
    ...
    return (case_count, hit_count), len(p_array) - np.sum(p_array), p_array
